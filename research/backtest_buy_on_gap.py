...
CLI::
    ...
    python -m research.backtest_buy_on_gap
    python -m research.backtest_buy_on_gap --gap-std-mult 1.5 --max-positions 3
    python -m research.backtest_buy_on_gap --no-trend-filter --start 2025-01-01
"""
