...
(`research/validate_kalman_trend.py`) and the backtest call into it; tests exercise it
directly.
    ...
    def from_frame(cls, df) -> "OHLC":
        ...
        if missing:
            raise ValueError(
                ...
                "Re-fetch with market_data/fetch_index_daily.py (which now persists OHLC); "
