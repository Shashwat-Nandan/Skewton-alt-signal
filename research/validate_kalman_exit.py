...
Reads data_cache/stf_5min/ (market_data/fetch_5min_stf.py) + daily bhavcopy for the OOS
...
Usage:
    python -m research.validate_kalman_exit                 # continuous + split, top-12
    python -m research.validate_kalman_exit --top 12 --debounce 2
"""
...
from research.backtest_kalman_pairs import _screen, _write_temp_config, load_5min_panel
from research.backtest_pairs import load_lot_sizes
from core.screen_pairs import NIFTY_50, load_front_month_panel
...
def main() -> int:
    ...
    if panel5.empty:
        print("No 5-min data in data_cache/stf_5min/ — run market_data/fetch_5min_stf.py first.")
        return 1
