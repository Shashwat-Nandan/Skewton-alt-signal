...
Usage:
    python -m research.compare_paper_systems                       # last 5 trading days
    python -m research.compare_paper_systems --days 10
    python -m research.compare_paper_systems --systems baseline,persistent
    python -m research.compare_paper_systems --end 2026-05-23 --days 5
"""
