...
What's different from `research/backtest_arbitrage.py`:
...
Usage:
    ...
    python -m research.backtest_calendar_meanreversion --universe RELIANCE,SBIN,ITC
    python -m research.backtest_calendar_meanreversion --entry-n-sd 1.5 --max-hold 5
    python -m research.backtest_calendar_meanreversion --compare-vs-arbitrage
"""
...
from research.backtest_arbitrage import (
    MockKiteArb,
    load_stf_panel,
