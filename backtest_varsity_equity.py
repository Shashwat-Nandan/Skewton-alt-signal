...
CLI::
    ...
    python backtest_varsity_equity.py
    python backtest_varsity_equity.py --short-window 20 --long-window 50
    python backtest_varsity_equity.py --capital 2000000 --start 2025-12-01
"""
