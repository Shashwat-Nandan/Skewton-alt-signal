...
Typical operator usage::
    ...
    python fetch_fii_dii.py             # fetch latest
    python fetch_fii_dii.py --date 2026-05-07   # write under that date

NSE archives are gated by Akamai. The fetcher works from the user's VPS
(where ``fetch_bhavcopy.py`` already works); short-lived dev environments
may 503.
"""
