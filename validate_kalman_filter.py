...
backtest (that is Phase 2, backtest_kalman_pairs.py). Determinism (fixed seed,
...
Usage:
  python validate_kalman_filter.py
  python validate_kalman_filter.py --csv data_cache/ewa_ewc.csv
"""
