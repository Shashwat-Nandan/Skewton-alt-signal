...
Usage:
  python variance_pnl_gate.py --regime data_cache/regime_<stem>.csv
"""
...
def main():
    ...
    p.add_argument("--regime", required=True, help="Per-day regime CSV from analyze_rv_iv_regime.py")
