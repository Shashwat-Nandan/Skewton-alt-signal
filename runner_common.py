...
These were grown and battle-tested inside run_paper_pairs.py (the live
pair runner); extracting them verbatim here lets run_paper_arbitrage.py
stop importing from a sibling *runner*, and lets run_paper.py /
run_equity_swing.py adopt the same protections without copy-paste drift.
...
deliberately stay in run_paper_pairs.py.
"""
