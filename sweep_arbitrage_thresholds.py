...
Usage:
    python sweep_arbitrage_thresholds.py
    python sweep_arbitrage_thresholds.py --from 2026-03-01 --to 2026-04-17
    python sweep_arbitrage_thresholds.py --entries 0.01,0.02,0.03,0.05 \\
                                          --exits   0.0,0.005,0.01
    python sweep_arbitrage_thresholds.py --universe RELIANCE,INFY,HDFCBANK \\
...
from backtest_arbitrage import load_stf_panel, run_backtest
