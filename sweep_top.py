...
Reuses every building block from backtest_pairs_rule.py. Output is a
...
Usage:
    python sweep_top.py
    python sweep_top.py --max-top 15 --screen-window 130 --test-horizon 10
"""
...
from backtest_pairs_rule import (
    aggregate_per_pair,
    portfolio_metrics,
