...
Differences vs the existing `backtest_pairs.py --train-fraction`:
...
Usage
-----
    python backtest_pairs_rule.py
    python backtest_pairs_rule.py --top 12 --test-horizon 10
    python backtest_pairs_rule.py --checkpoint-stride 5 --screen-window 130
"""
