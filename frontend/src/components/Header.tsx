...
import { LogOut, Activity, BarChart3, Briefcase, GitBranch, Layers, Scale, TrendingDown, TrendingUp } from "lucide-react";
        ...
        <div className="flex min-w-0 items-center gap-3 sm:gap-6">
          ...
          <nav className="-mx-1 flex min-w-0 items-center gap-1 overflow-x-auto px-1 text-sm">
            ...
            >
              ...
              <span className="hidden sm:inline">Persistent Pairs</span>
              <span className="sm:hidden">Persist</span>
            </NavLink>
            <NavLink
              to="/equity-swing"
              className={({ isActive }) =>
            ...
            >
              ...
              <span className="hidden sm:inline">Buy-on-Gap</span>
