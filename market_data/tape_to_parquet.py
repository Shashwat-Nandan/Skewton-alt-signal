...
convert_tape_to_parquet() (in research/backtest.py) does the convert + fail-loud
...
the project dir (paths are relative to ./data_cache, matching the loaders).
    ...
    python -m market_data.tape_to_parquet 2026-07-17
"""
import argparse
import sys
from pathlib import Path

from research.backtest import convert_tape_to_parquet
