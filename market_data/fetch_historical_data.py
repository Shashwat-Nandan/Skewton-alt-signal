...
Usage:
  ...
  python -m market_data.fetch_historical_data --from-date 2026-03-01 --to-date 2026-03-30
...
def main():
    ...
    print("\nTo run backtest:")
    print(f"  python -m research.backtest --data {output_path} --underlying {args.underlying}")
    print("\nTo run autoresearch:")
    print(f"  python -m runners.run_autoresearch --data {output_path}")
