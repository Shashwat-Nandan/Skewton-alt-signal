...
Usage (on host):
    python -m market_data.fetch_index_daily --symbol BANKNIFTY --days 400
    python -m market_data.fetch_index_daily --symbol NIFTY --from-date 2025-05-01 --to-date 2026-05-31
    python -m market_data.fetch_index_daily --symbol FINNIFTY --nse-symbol "NIFTY FIN SERVICE"
"""
