...
(python -m research.backtest_kalman_pairs --timeframe 5min) loads these.
...
after market close, reusing that session:
    python -m market_data.fetch_5min_stf --days 90
    python -m market_data.fetch_5min_stf --symbols RELIANCE,INFY --days 60
"""
...
from core.data_cache_io import read_table, write_table  # noqa: E402
