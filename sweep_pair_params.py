...
plumbing of backtest_pairs.py (--train-fraction re-screens on train slice).

Usage:
    # In-sample on cached pair_candidates.csv (lookahead bias):
    python sweep_pair_params.py --top 5

    # OOS (honest):
    python sweep_pair_params.py --top 8 --train-fraction 0.7
